(function () {
  ...
  var LANG = {
    en: {
      ...
      op_ref_placeholder: "op://vault/item/field",
      op_fetch: "Fetch from 1Password",
      op_fetching: "Fetching from 1Password…",
      op_fetched: "Fetched from 1Password. Save to store it in the keyring.",
      op_browse: "Browse 1Password…",
      op_pick_item: "Select 1Password item",
      op_pick_field: "Select field",
      op_filter_items: "Search items…",
      op_filter_fields: "Filter fields…",
      op_back_to_items: "Back",
      op_refresh: "Reload",
      op_loading: "Loading from 1Password…",
      op_loading_items: "Loading items from 1Password… (the first load takes ~10s; 1Password may ask for approval)",
      op_no_items: "No matching items",
      op_no_fields: "No referenceable fields",
      op_more_items: "Showing the first {n}. Narrow the search.",
      ...
      sync_blocked_newer: "The sync file was written by a newer version of muSQL. Skipped writing to avoid overwriting its newer settings. Update this machine, then try again.",
    ...
    ja: {
      ...
      op_ref_placeholder: "op://vault/item/field",
      op_fetch: "1Password から取得",
      op_fetching: "1Password から取得しています…",
      op_fetched: "1Password から取得しました。保存するとキーリングに格納されます。",
      op_browse: "1Password から選ぶ…",
      op_pick_item: "1Password のアイテムを選択",
      op_pick_field: "フィールドを選択",
      op_filter_items: "アイテムを検索…",
      op_filter_fields: "フィールドを絞り込み…",
      op_back_to_items: "戻る",
      op_refresh: "再読み込み",
      op_loading: "1Password から読み込んでいます…",
      op_loading_items: "1Password のアイテム一覧を読み込んでいます…（初回は10秒ほどかかります。1Password の承認を求められることがあります）",
      op_no_items: "一致するアイテムがありません",
      op_no_fields: "参照できるフィールドがありません",
      op_more_items: "先頭 {n} 件を表示しています。検索して絞り込んでください。",
      ...
      sync_blocked_newer: "同期ファイルはより新しいバージョンの muSQL で書き込まれています。新しい設定を上書きしないよう、書き出しを中止しました。このマシンを更新してから再度お試しください。",
